...
func SearchV2() []string {
	...
	tweetResponse, err := client.TweetRecentSearch(context.Background(), `verified Noida (bed OR beds OR icu OR oxygen OR ventilator OR ventilators) -"not verified" -"unverified" -"needed" -"required"`, opts)
	if err != nil {
